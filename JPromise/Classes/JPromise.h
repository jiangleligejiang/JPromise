...
//  主要用于流程复杂的业务，可以通过`j_then`操作将业务串联起来，若流程中出错，则可以通过`j_catch`获取到错误，并将终止流程，若流程被自动取消，则可以通过`j_cancel`获取到通知
...
typedef void(^JPromiseBlock)(JPromiseFulfillBlock fulfill, JPromiseRejectBlock reject);
...
+ (instancetype)promiseWithBlock:(JPromiseBlock)promiseBlock target:(_Nullable id)target;
